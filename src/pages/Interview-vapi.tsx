...
const Interview = () => {
  ...
  const {
    ...
    stopCall,
    setMuted,
  } = useVapi(vapiConfig, phase);

  // Auto-start call when component mounts and Vapi is connected
  useEffect(() => {
            ...
            <div className="flex items-center gap-2 text-xs">
              {isCallActive ? (
                <>
                  ...
                  <span className="text-muted-foreground">Live Call</span>
                </>
              ) : isConnected ? (
                <>
            ...
            <div className="space-y-8 text-center">
              ...
              <div className="flex justify-center">
                <div className="relative">
                  ...
                  {isCallActive && volumeLevel > 0 && (
                    <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-32 h-2 bg-muted rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-phase-fit transition-all duration-100"
              ...
              <div className="space-y-4 max-w-2xl mx-auto">
                ...
                <p className="text-lg text-muted-foreground">
                  We're starting with some questions about your background and motivations. 
          ...
          {phase === "BRAINTEASER" && (
            <div className="space-y-8">
              <div className="text-center space-y-2 mb-8">
                ...
                <p className="text-muted-foreground">
                  Now we'll test your reasoning with a logic puzzle. Think out loud and explain your approach.
                </p>
              </div>
